        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                >
                  ...
                  {departmentsQuery.data?.departments.map((department) => (
                    <option key={department.id} value={department.id}>
                      {department.branch.code}-{department.code} -{" "}
                      {department.name}
                    </option>
                  ))}
                </select>
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div>
                <label className="mb-2 block text-sm font-medium text-gray-700">
                  {t("assets.serialNumberInternal")}{" "}
                  <span className="text-xs text-gray-500">
                    {t("assets.internalLabel")}
                  </span>
                </label>
                <input
                  type="text"
              ...
              <div className="md:col-span-2">
                <label className="mb-2 block text-sm font-medium text-gray-700">
                  {t("assets.supplierSerialNumber")}{" "}
                  <span className="text-xs text-gray-500">
                    {t("assets.manufacturerSN")}
                  </span>
                </label>
                <input
                  type="text"
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div>
                <label className="mb-2 block text-sm font-medium text-gray-700">
                  {t("assets.acquisitionCost")} *{" "}
                  <span className="text-xs text-gray-500">
                    {t("assets.originalValue")}
                  </span>
                </label>
                <input
                  type="number"
              ...
              <div>
                <label className="mb-2 block text-sm font-medium text-gray-700">
                  {t("assets.serviceDate")}{" "}
                  <span className="text-xs text-gray-500">
                    {t("assets.datePutIntoService")}
                  </span>
                </label>
                <input
                  type="date"
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div>
                ...
                >
                  <option value="STRAIGHT_LINE">
                    {t("assets.straightLine")}
                  </option>
                  <option value="DECLINING_BALANCE">
                    {t("assets.decliningBalance")}
                  </option>
                  <option value="UNITS_OF_PRODUCTION">
                    {t("assets.unitsOfProduction")}
                  </option>
                  <option value="SUM_OF_YEARS_DIGITS">
                    {t("assets.sumOfYearsDigits")}
                  </option>
                </select>
              </div>
              ...
              <div>
                <label className="mb-2 block text-sm font-medium text-gray-700">
                  {t("assets.usefulLifeYears")}{" "}
                  <span className="text-xs text-gray-500">
                    {t("assets.accountingLabel")}
                  </span>
                </label>
                <input
                  type="number"
                ...
                <>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={3}
                      placeholder={t(
                        "assets.maintenanceObligationsPlaceholder",
                      )}
                      className="block w-full rounded-lg border border-gray-300 px-3 py-2 focus:border-transparent focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div>
              <label className="mb-2 block text-sm font-medium text-gray-700">
                {t("assets.observations")}{" "}
                <span className="text-xs text-gray-500">
                  {t("assets.specialConditions")}
                </span>
              </label>
              <textarea
