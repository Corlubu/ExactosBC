...
export const updateAsset = baseProcedure
  ...
  .mutation(async ({ input }) => {
    ...
    if (input.acquisitionCost !== undefined)
      updateData.acquisitionCost = input.acquisitionCost;
    if (input.currentValue !== undefined)
      updateData.currentValue = input.currentValue;
    if (input.residualValue !== undefined)
      updateData.residualValue = input.residualValue;
    if (input.serviceDate !== undefined)
      updateData.serviceDate = input.serviceDate;
    if (input.depreciationMethod !== undefined)
      updateData.depreciationMethod = input.depreciationMethod;
    if (input.usefulLifeYears !== undefined)
      updateData.usefulLifeYears = input.usefulLifeYears;
    if (input.usefulLifeUnits !== undefined)
      updateData.usefulLifeUnits = input.usefulLifeUnits;
    if (input.convention !== undefined)
      updateData.convention = input.convention;
    ...
    if (input.purchaseDocument !== undefined)
      updateData.purchaseDocument = input.purchaseDocument;
    if (input.supplierSerialNumber !== undefined)
      updateData.supplierSerialNumber = input.supplierSerialNumber;
    if (input.unitCost !== undefined) updateData.unitCost = input.unitCost;
    if (input.quantity !== undefined) updateData.quantity = input.quantity;
    if (input.currency !== undefined) updateData.currency = input.currency;
    if (input.depreciationPercentage !== undefined)
      updateData.depreciationPercentage = input.depreciationPercentage;
    if (input.depreciationStartDate !== undefined)
      updateData.depreciationStartDate = input.depreciationStartDate;
    if (input.accountingAssetAccount !== undefined)
      updateData.accountingAssetAccount = input.accountingAssetAccount;
    if (input.accumulatedDepreciationAccount !== undefined)
      updateData.accumulatedDepreciationAccount =
        input.accumulatedDepreciationAccount;
    if (input.depreciationExpenseAccount !== undefined)
      updateData.depreciationExpenseAccount = input.depreciationExpenseAccount;
    if (input.fixedAssetLedger !== undefined)
      updateData.fixedAssetLedger = input.fixedAssetLedger;
    if (input.classCode !== undefined) updateData.classCode = input.classCode;
    if (input.costCenterCode !== undefined)
      updateData.costCenterCode = input.costCenterCode;
    if (input.areaCode !== undefined) updateData.areaCode = input.areaCode;
    if (input.subareaCode !== undefined)
      updateData.subareaCode = input.subareaCode;
    if (input.branchCode !== undefined)
      updateData.branchCode = input.branchCode;
    ...
    if (input.assetTypeId !== undefined)
      updateData.assetTypeId = input.assetTypeId;
    if (input.seriesNumber !== undefined)
      updateData.seriesNumber = input.seriesNumber;
    if (input.invoiceNumber !== undefined)
      updateData.invoiceNumber = input.invoiceNumber;
    if (input.component1 !== undefined)
      updateData.component1 = input.component1;
    if (input.component2 !== undefined)
      updateData.component2 = input.component2;
    if (input.component3 !== undefined)
      updateData.component3 = input.component3;
    if (input.activityProject !== undefined)
      updateData.activityProject = input.activityProject;
